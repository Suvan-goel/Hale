# Pearl Closed-Beta Physical-Device QA Protocol

> **Superseded full-battery protocol.** This document is retained as historical device evidence
> only. It does not describe Pearl's current MVP battery or product scope. Current QA lives in
> `docs/pearl-v1-manual-qa.md`, and current product authority lives in `AGENTS.md`.

Status: archived evidence template. Do not use it to plan current beta scope.
