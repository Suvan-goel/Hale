# Pearl Landing Page Design Audit

Date: 2026-06-21

> Superseded 2026-07-06: the old Pearl `website/` landing app has been retired.
> Current paid-traffic work targets `landing/` only, under the Pearl public
...
- `src/components/HeaderLogo.tsx`: logo mark source is `assets/pearl-logo-mark.png`.
...
- Logo mark: `assets/pearl-logo-mark.png`, copied unchanged to `website/public/brand/pearl-logo-mark.png`.
- App icon: `assets/ios-icon.png`, copied unchanged to `website/public/brand/pearl-app-icon.png`.
...
- Supporting images copied from current app assets:
  ...
  - `assets/images/pearl-todays-session-card.png`
