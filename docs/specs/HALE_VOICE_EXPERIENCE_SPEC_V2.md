...
- DURATION-001: corrected. HALE_VOICE_COMPOSED_TIMELINES_V2.csv models full sequences for both voices and 0/100/250ms gaps. Validation: Timeline rows include cold-equipment and warm-equipment variants; standing-band-row has door-anchor family cue in cold-equipment timeline.
