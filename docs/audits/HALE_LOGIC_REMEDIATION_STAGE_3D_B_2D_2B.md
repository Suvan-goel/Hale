# Hale Logic Remediation Stage 3D-B.2D.2B
...
?? docs/audits/HALE_VOICE_EXPERIENCE_SPEC_CODEX_PROMPT.md
?? docs/audits/HALE_VOICE_RUNTIME_TIMELINE_AUDIT.json
?? docs/audits/HALE_VOICE_RUNTIME_TIMELINE_AUDIT.md
?? docs/audits/HALE_VOICE_RUNTIME_TIMELINE_AUDIT_CODEX_PROMPT.md
?? docs/audits/Hale_Stage_3D_B_2D_2A_V2_Assessment_Persistence_Orchestration_Prompt.md
?? docs/audits/Hale_Stage_3D_B_2D_2B_Internal_V2_CheckUp_Movement_Profile_UI_Prompt.md
...
- `npx --no-install expo export --platform all --output-dir /tmp/hale-stage3db2d2b-export`: passed, Android/iOS bundles exported, 380 assets, temp export directory removed.
