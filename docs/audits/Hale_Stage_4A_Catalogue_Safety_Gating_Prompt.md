You are implementing Stage 4A of Hale’s production-readiness work:
...
- tests under src/exercises, src/training, src/haleFlow, src/adherence relevant to catalogue/session generation.
