# Codex Prompt: Hale Step-Up Runtime Evidence Closure — Full Coverage and Per-Metric Proof

Read this entire prompt before doing any work.

This is the final audit-only correction for Hale’s step-up alternation runtime phase.
...
1. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE.md`
2. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE.json`
3. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE_SCENARIOS.csv`
4. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE_EVENTS.csv`
5. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE_LIFECYCLES.csv`
6. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE_FINDINGS.csv`
7. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_CLOSURE_VALIDATION.csv`
8. `docs/audits/HALE_VOICE_PROJECT_POST_STEP_UP_EVIDENCE_CLOSURE_HANDOFF.md`
