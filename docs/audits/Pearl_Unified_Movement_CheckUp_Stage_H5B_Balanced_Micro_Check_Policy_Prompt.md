You are implementing the second substage of Pearl’s final unified Movement Check-Up migration:
...
```bash
rm -rf /tmp/pearl-unified-h5b-baseline-export
npx --no-install expo export --platform all --output-dir /tmp/pearl-unified-h5b-baseline-export
rc=$?
rm -rf /tmp/pearl-unified-h5b-baseline-export
exit $rc
```
...
```bash
rm -rf /tmp/pearl-unified-h5b-export
