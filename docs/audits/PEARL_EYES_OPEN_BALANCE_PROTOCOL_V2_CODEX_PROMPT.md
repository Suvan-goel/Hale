# Codex Prompt: Pearl Eyes-Open Balance Protocol V2 Reconciliation

Read this entire prompt before changing anything.

Pearl’s measurement-side and protocol foundation is now complete.
...
1. `docs/audits/PEARL_EYES_OPEN_BALANCE_V2_IMPLEMENTATION.md`
2. `docs/audits/PEARL_EYES_OPEN_BALANCE_V2_AUDIT.md`
3. `docs/audits/PEARL_EYES_OPEN_BALANCE_V2_AUDIT.json`
4. `docs/audits/PEARL_EYES_OPEN_BALANCE_V2_SCENARIOS.csv`
5. `docs/audits/PEARL_EYES_OPEN_BALANCE_V2_VOICE_ASSET_REQUIREMENTS.csv`
6. `docs/audits/PEARL_VOICE_PROJECT_POST_BALANCE_V2_HANDOFF.md`
...
# Pearl Eyes-Open Balance Protocol V2 Implementation
