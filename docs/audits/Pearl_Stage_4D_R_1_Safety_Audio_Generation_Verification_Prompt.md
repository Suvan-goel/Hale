You are carrying out Stage 4D-R.1 of Pearl’s production-readiness work:
...
Stage 4D-R.1 must generate and verify those assets for both supported Pearl voices:
...
### 3. Use the existing Pearl voice identities and provider configuration
...
Do not regenerate all existing Pearl audio.
