You are implementing Stage 4D-R of Hale’s production-readiness work:
...
Do not claim Hale has inspected the door or anchor.
...
- fear-heavy language;
- internal IDs;
- claims that Hale inspected equipment.
