# Pearl Training Step-Up Alternation Audit
...
See `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_SCENARIOS.csv` and `docs/audits/PEARL_TRAINING_STEP_UP_REP_EVIDENCE_MATRIX.csv`.
