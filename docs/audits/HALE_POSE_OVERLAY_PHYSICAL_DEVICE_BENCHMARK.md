# Hale Pose Overlay Physical-Device Benchmark

Date: 2026-06-22

Scope: physical-device benchmark readiness for Hale's real-time pose overlay, plus the point-cloud renderer scheduling audit requested in `docs/audits/HALE_POSE_OVERLAY_PHYSICAL_DEVICE_BENCHMARK_PROMPT.txt`.
...
1. Prop the phone in the normal Hale setup position.
