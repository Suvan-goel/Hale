...
- Upstream: origin/dev
- Pre-existing diff files: App.tsx, src/haleFlow/__tests__/movementProfileV2OfficialRetestTransition.test.ts, src/results/__tests__/movementProfileV2ResultsAdapter.test.ts, src/services/backend/__tests__/blockReportSyncService.test.ts
