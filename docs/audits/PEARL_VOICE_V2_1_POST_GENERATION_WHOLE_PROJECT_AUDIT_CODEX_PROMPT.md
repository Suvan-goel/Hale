# Codex Prompt: Pearl Post-Generation Whole-Project Voice V2.1 Static/Runtime Audit With Measured Durations

Read this entire prompt before doing anything.

Pearl’s consolidated Clara/Marcus Voice V2.1 asset-generation pass is complete.
...
The purpose is to decide whether Pearl is ready for the next phase:
...
```bash
find assets/audio -type f | sort > /tmp/pearl_voice_v21_post_generation_entry.files
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/pearl_voice_v21_post_generation_entry.sha256
```
...
- `docs/audits/PEARL_VOICE_V2_1_ASSET_GENERATION_IMPLEMENTATION.md`
- `docs/audits/PEARL_VOICE_V2_1_ASSET_GENERATION_AUDIT.md`
- `docs/audits/PEARL_VOICE_V2_1_ASSET_GENERATION_AUDIT.json`
- `docs/audits/PEARL_VOICE_V2_1_GENERATION_PLAN.csv`
- `docs/audits/PEARL_VOICE_V2_1_GENERATION_RESULT_LEDGER.csv`
- `docs/audits/PEARL_VOICE_V2_1_GENERATED_ASSET_INVENTORY.csv`
- `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_MANIFEST_CHANGES.csv`
- `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_TIMELINES.csv`
- `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_READINESS.csv`
- `docs/audits/PEARL_VOICE_V2_1_LISTENING_REVIEW_QUEUE.csv`
- `docs/audits/PEARL_VOICE_V2_1_LISTENING_REVIEW_GUIDE.md`
- `docs/audits/PEARL_VOICE_V2_1_LISTENING_REVIEW.html`
...
- `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_COMPLETION_AUDIT.json` if present
...
- `docs/audits/PEARL_TRAINING_FLOOR_READINESS_POST_SAFETY_REBASE.md`
- `docs/audits/PEARL_TRAINING_FLOOR_READINESS_POST_SAFETY_REBASE.json`
- `docs/audits/PEARL_TRAINING_FLOOR_READINESS_POST_SAFETY_SCENARIOS.csv`
- `docs/audits/PEARL_TRAINING_FLOOR_CONTRACT_MATRIX_POST_SAFETY.csv`
- `docs/audits/PEARL_VOICE_PROJECT_POST_FLOOR_READINESS_POST_SAFETY_HANDOFF.md`
...
```bash
find assets/audio -type f | sort > /tmp/pearl_voice_v21_whole_project_entry.files
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/pearl_voice_v21_whole_project_entry.sha256
```

At task end:

```bash
find assets/audio -type f | sort > /tmp/pearl_voice_v21_whole_project_exit.files
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/pearl_voice_v21_whole_project_exit.sha256
diff -u /tmp/pearl_voice_v21_whole_project_entry.files /tmp/pearl_voice_v21_whole_project_exit.files
diff -u /tmp/pearl_voice_v21_whole_project_entry.sha256 /tmp/pearl_voice_v21_whole_project_exit.sha256
```
...
1. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_WHOLE_PROJECT_AUDIT.md`
2. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_WHOLE_PROJECT_AUDIT.json`
3. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_RUNTIME_SCENARIOS.csv`
4. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_TIMELINE_AUDIT.csv`
5. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_PHYSICAL_AUDIO_AUDIT.csv`
6. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_READINESS_MATRIX.csv`
7. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_FAILURE_INJECTION.csv`
8. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_LISTENING_REVIEW_PLAN.md`
9. `docs/audits/PEARL_VOICE_V2_1_POST_GENERATION_LISTENING_QUEUE.csv`
10. `docs/audits/PEARL_VOICE_PROJECT_POST_WHOLE_PROJECT_AUDIT_HANDOFF.md`
...
```text
docs/audits/PEARL_VOICE_PROJECT_POST_WHOLE_PROJECT_AUDIT_HANDOFF.md
```
