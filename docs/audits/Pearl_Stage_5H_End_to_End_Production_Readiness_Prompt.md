You are carrying out Stage 5H of Pearl’s production-readiness work:
...
> Can Pearl reliably transform a valid official Movement Check-Up into four weeks of safe, useful, deterministic, credit-honest training, survive interruptions/sync/restore, complete a valid official re-test exactly once, and create the next block without losing trust?
...
- `src/pearlFlow/__tests__/stage5hAdversarial.test.ts`
...
Stage 5H must not declare Pearl generally beta-ready while those non-Stage-5 gates remain.
