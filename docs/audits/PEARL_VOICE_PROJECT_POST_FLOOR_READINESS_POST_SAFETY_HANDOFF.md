# Pearl Voice Project Post Floor Readiness Post-Safety Handoff
...
The regenerated audio corpus is user-owned dirty work relative to Git HEAD. This task compares audio against the task-start hash file `/tmp/pearl_floor_post_safety_audio_entry.sha256`; hash diffs this task: 0.
