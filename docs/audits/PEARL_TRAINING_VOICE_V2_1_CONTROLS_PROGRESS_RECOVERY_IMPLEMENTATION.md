...
Logical control assets are recorded in docs/audits/PEARL_TRAINING_VOICE_V2_1_CONTROL_ASSET_REQUIREMENTS.csv. No physical manifest entries or audio files were added.
...
See docs/audits/PEARL_TRAINING_VOICE_V2_1_CONTROLS_PROGRESS_RECOVERY_AUDIT.json.
