You are carrying out the final sign-off continuation for Hale’s Balanced micro-check verification:

HALE UNIFIED MOVEMENT CHECK-UP — STAGE H5B.1 CONTINUATION
...
```text
/tmp/hale-h5b1-audio-signoff-after.sha256
```
