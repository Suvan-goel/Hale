# Codex Prompt: Hale Final Voice V2.1 Cue Schema and Physical Manifest Reconciliation

Read this entire prompt before changing anything.

Hale's V2.1 voice behavior is now software-complete for Training and Micro-Check, and the next phase is:
...
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/hale_final_voice_schema_audio_entry.sha256
```
...
```bash
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/hale_final_voice_schema_audio_exit.sha256
diff -u /tmp/hale_final_voice_schema_audio_entry.sha256 /tmp/hale_final_voice_schema_audio_exit.sha256
```
...
- `docs/audits/HALE_TRAINING_VOICE_V2_1_SAFETY_*`
- `docs/audits/HALE_TRAINING_VOICE_V2_1_FOUNDATION_*`
...
1. `docs/audits/HALE_VOICE_V2_1_FINAL_CUE_SCHEMA_IMPLEMENTATION.md`
2. `docs/audits/HALE_VOICE_V2_1_FINAL_CUE_SCHEMA_AUDIT.md`
3. `docs/audits/HALE_VOICE_V2_1_FINAL_CUE_SCHEMA_AUDIT.json`
4. `docs/audits/HALE_VOICE_V2_1_FINAL_CUE_REGISTRY.csv`
5. `docs/audits/HALE_VOICE_V2_1_PHYSICAL_ASSET_RECONCILIATION.csv`
6. `docs/audits/HALE_VOICE_V2_1_MANIFEST_CHANGE_PLAN.csv`
7. `docs/audits/HALE_VOICE_V2_1_GENERATION_BACKLOG.csv`
8. `docs/audits/HALE_VOICE_V2_1_RETIREMENT_LEGACY_MAP.csv`
9. `docs/audits/HALE_VOICE_V2_1_SCHEMA_TIMELINES.csv`
10. `docs/audits/HALE_VOICE_V2_1_SCHEMA_RUNTIME_SCENARIOS.csv`
11. `docs/audits/HALE_VOICE_PROJECT_POST_FINAL_CUE_SCHEMA_HANDOFF.md`
...
# Hale Voice V2.1 Final Cue Schema Implementation
