You are implementing Stage 3D-B.2D.2A of Pearl’s production-readiness work:
...
Before UI or block creation can consume V2 results, Pearl must prove this invariant:
...
- balance Pearl task bands and Springer benchmark metadata;
...
- balance starting-point task bands may drive Pearl-band focus;
