...
1. `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_AUDIT.md`
2. `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_AUDIT.json`
3. `docs/audits/PEARL_MPV2_RUNTIME_TIMELINES.csv`
4. `docs/audits/PEARL_MPV2_RUNTIME_FINDINGS.csv`
5. `docs/audits/PEARL_MPV2_RUNTIME_REMEDIATION_PLAN.md`
6. `docs/audits/PEARL_MPV2_LISTENING_REVIEW_WAIVER.md`
...
Run every scenario in `PEARL_MPV2_TARGETED_RUNTIME_AUDIT_SCOPE.md`.
...
# Pearl MPV2 Targeted Runtime Audit
...
# Pearl MPV2 Listening Review Waiver
...
1. Parse `PEARL_MPV2_TARGETED_RUNTIME_AUDIT_INPUT.json`.
2. Parse `PEARL_MPV2_V21_VOICE_RECONCILIATION.json`.
3. Parse `PEARL_VOICE_EXPERIENCE_SPEC_V2_1.json`.
