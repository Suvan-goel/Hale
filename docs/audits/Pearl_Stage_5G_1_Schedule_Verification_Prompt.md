You are carrying out Stage 5G.1 of Pearl’s production-readiness work:
...
- `src/pearlFlow/blockSchedule.ts` as the deterministic scheduler;
...
- focused PearlFlow tests: 4 suites / 76 tests passed;
