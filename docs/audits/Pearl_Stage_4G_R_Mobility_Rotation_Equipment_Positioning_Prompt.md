You are implementing Stage 4G-R of Pearl’s production-readiness work:
...
Pearl’s equipment positioning must be more precise.
...
- Pearl is not a complete “zero-equipment” programme for every movement domain;
...
- implement ecommerce or a Pearl Movement Kit purchase flow;
...
- “Pearl varies these movements across your block.”
...
- “Pearl will continue varying these movements.”
...
> Pearl plans around what you have, but some movements may be unavailable without household support or a resistance band.
...
- Pearl adapts to confirmed setup.
...
It remains acceptable to explain that Pearl uses the phone camera as the measurement sensor.

However, copy must distinguish:

### Measurement

- “Pearl uses your phone camera to estimate movement.”
...
- require a Pearl Movement Kit;
- claim that a proprietary kit is necessary.

It is acceptable to say:

> A long resistance band is the first optional item Pearl recommends as your programme expands.
...
- no “Pearl inspected your setup” implication.
...
Stage 4G-R must not declare Pearl generally beta-ready.
