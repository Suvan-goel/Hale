# Codex Prompt: Pearl Step-Up Alternation Verification Addendum

Read this entire prompt before doing any work.

Pearl’s default-closed step-up alternation implementation has reported:
...
1. `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_VERIFICATION_ADDENDUM.md`
2. `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_VERIFICATION_ADDENDUM.json`
3. `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_SCENARIOS_V2.csv`
4. `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_EVENT_EVIDENCE.csv`
5. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_INTEGRATION_TRACE.csv`
6. `docs/audits/PEARL_VOICE_PROJECT_POST_STEP_UP_VERIFICATION_HANDOFF.md`
