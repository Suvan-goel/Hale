...
```text
hale@0.1.0 typecheck: passed
@hale/website@0.1.0 typecheck: passed
```
...
```bash
rm -rf /tmp/hale-unified-h2-export && npx --no-install expo export --platform all --output-dir /tmp/hale-unified-h2-export; rc=$?; rm -rf /tmp/hale-unified-h2-export; exit $rc
```
...
?? docs/audits/HALE_CONSTELLATION_V2_BENCHMARK_CODEX_PROMPT.md
?? docs/audits/HALE_CONSTELLATION_V2_BENCHMARK_CODEX_PROMPT.txt
?? docs/audits/HALE_EYES_OPEN_BALANCE_PROTOCOL_V2_CODEX_PROMPT.md
...
?? docs/audits/HALE_MEASUREMENT_PROTOCOL_COMPATIBILITY_MATRIX.csv
?? docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_METADATA_AUDIT.json
?? docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_METADATA_AUDIT.md
?? docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_METADATA_CODEX_PROMPT.md
?? docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_METADATA_IMPLEMENTATION.md
?? docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_POST_UX_AUDIT.json
?? docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_POST_UX_AUDIT.md
?? docs/audits/HALE_MEASUREMENT_SIDE_UX_COMPLETION_CODEX_PROMPT.md
?? docs/audits/HALE_MEASUREMENT_SIDE_UX_COMPLETION_IMPLEMENTATION.md
?? docs/audits/HALE_MEASUREMENT_SIDE_UX_SCENARIOS.csv
?? docs/audits/HALE_RIGGED_HUMAN_SILHOUETTE_BENCHMARK.md
?? docs/audits/HALE_RIGGED_HUMAN_SILHOUETTE_CODEX_PROMPT.md
?? docs/audits/HALE_TRAINING_VOICE_V2_1_FOUNDATION_CODEX_PROMPT.md
...
?? docs/audits/Hale_Unified_Movement_CheckUp_Stage_H0_Health_Gate_Prompt.md
?? docs/audits/Hale_Unified_Movement_CheckUp_Stage_H1_Polished_V1_Shell_V2_Adapter_Prompt.md
?? docs/audits/Hale_Unified_Movement_CheckUp_Stage_H2_Polished_V1_Results_V2_Profile_Prompt.md
