You are resuming the policy-aligned closure verification for Hale’s unified Movement Check-Up lifecycle:

HALE UNIFIED MOVEMENT CHECK-UP — STAGE H4.1.1 CONTINUATION
...
Hale preserves the prior domain.
...
src/haleFlow/__tests__/movementProfileV2OfficialRetestConsumers.integration.test.ts
