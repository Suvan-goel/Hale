# Hale Unified Movement Check-Up Stage H3 Baseline / Onboarding Cutover
...
- `npx --no-install expo export --platform all --output-dir /tmp/hale-unified-h3-baseline-export`: passed, Android/iOS bundles, 444 assets, existing Sentry and `NO_COLOR`/`FORCE_COLOR` warnings; temp dir removed.
...
- `docs/audits/HALE_UNIFIED_MOVEMENT_CHECKUP_STAGE_H3_BASELINE_ONBOARDING_CUTOVER.md`: this report.
