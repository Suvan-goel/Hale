# Codex Prompt: Hale Voice Specification V2.1 — Apply Approved Founder Decisions and Prepare Final Human Script Review

Read this entire prompt before starting.

Hale has completed the following voice-analysis and specification work:
...
- `docs/specs/HALE_VOICE_EXPERIENCE_SPEC.md`
- `docs/specs/HALE_VOICE_EXPERIENCE_SPEC.json`
- `docs/specs/HALE_VOICE_SCRIPT_REVIEW.md`
- `docs/specs/HALE_VOICE_SCRIPT_MANIFEST.csv`
- `docs/specs/HALE_VOICE_EXPERIENCE_SPEC_V2.md`
- `docs/specs/HALE_VOICE_EXPERIENCE_SPEC_V2.json`
- `docs/specs/HALE_VOICE_SCRIPT_REVIEW_V2.md`
- `docs/specs/HALE_VOICE_SCRIPT_MANIFEST_V2.csv`
- `docs/specs/HALE_VOICE_FOUNDER_DECISIONS.md`
- `docs/specs/HALE_VOICE_COMPOSED_TIMELINES_V2.csv`
...
Create Hale Voice Specification V2.1 as the corrected, internally consistent, decision-complete specification.
...
1. `docs/specs/HALE_VOICE_EXPERIENCE_SPEC_V2_1.md`
2. `docs/specs/HALE_VOICE_EXPERIENCE_SPEC_V2_1.json`
3. `docs/specs/HALE_VOICE_SCRIPT_REVIEW_V2_1.md`
4. `docs/specs/HALE_VOICE_SCRIPT_MANIFEST_V2_1.csv`
5. `docs/specs/HALE_VOICE_COMPOSED_TIMELINES_V2_1.csv`
6. `docs/specs/HALE_VOICE_APPROVED_DECISIONS_V2_1.md`
7. `docs/specs/HALE_VOICE_CLARA_PREVIEW_PACK_PLAN_V2_1.md`

Do not edit the V2 files.

## Artifact roles

### `HALE_VOICE_EXPERIENCE_SPEC_V2_1.md`
...
### `HALE_VOICE_APPROVED_DECISIONS_V2_1.md`
...
- At baseline, Hale selects or confirms a side that is:
...
- Do not promise that Hale can assist a floor transfer.
...
`HALE_VOICE_APPROVED_DECISIONS_V2_1.md` must include for each FD:
