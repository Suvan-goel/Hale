You are implementing Stage 3D-C of Pearl’s production-readiness work:
...
This is not safe enough for beta because it lets Pearl tell a user that strength is the suggested focus even when strength, balance, and mobility are exactly tied.

## Primary objective

Implement an explicit exact-tie contract so that Pearl can:
...
- “Pearl found a balanced starting point.”
- “These areas were closely matched, so Pearl is using a balanced starting focus.”
- “These areas were closely matched, so Pearl is keeping your current focus.”
- “Suggested focus”
...
- src/pearlFlow/focusSelection.ts
...
- “Pearl is using a balanced starting focus.”
or, if fallback:
- “Your results were closely matched. Pearl is starting with [focus] as a practical first focus.”

### Exact tie official re-test with preserved focus
Use:
- “Your results were closely matched, so Pearl is keeping your current focus.”
