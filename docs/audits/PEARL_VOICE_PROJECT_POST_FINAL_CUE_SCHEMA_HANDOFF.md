# Pearl Voice Project Post Final Cue Schema Handoff

Verdict: `VOICE_V2_1_FINAL_SCHEMA_COMPLETE_AUDIO_READY`

## Artifact Paths

- Final registry: `docs/audits/PEARL_VOICE_V2_1_FINAL_CUE_REGISTRY.csv`
- Physical reconciliation: `docs/audits/PEARL_VOICE_V2_1_PHYSICAL_ASSET_RECONCILIATION.csv`
- Manifest plan: `docs/audits/PEARL_VOICE_V2_1_MANIFEST_CHANGE_PLAN.csv`
- Generation backlog: `docs/audits/PEARL_VOICE_V2_1_GENERATION_BACKLOG.csv`
- Retirement/legacy map: `docs/audits/PEARL_VOICE_V2_1_RETIREMENT_LEGACY_MAP.csv`
- Timelines: `docs/audits/PEARL_VOICE_V2_1_SCHEMA_TIMELINES.csv`
- Runtime scenarios: `docs/audits/PEARL_VOICE_V2_1_SCHEMA_RUNTIME_SCENARIOS.csv`
- Audit JSON: `docs/audits/PEARL_VOICE_V2_1_FINAL_CUE_SCHEMA_AUDIT.json`
...
Use `docs/audits/PEARL_VOICE_V2_1_GENERATION_BACKLOG.csv`. Each row includes logical cue key, exact script, flow, category, policy, requiredness, voice IDs needed, current candidate, reuse decision, reason, budget class, and source.
