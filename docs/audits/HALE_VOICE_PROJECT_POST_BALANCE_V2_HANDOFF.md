# Hale Voice Project Handoff After Balance V2
...
All exact instruction mappings for the 37 registered exercise levels remain ungenerated. Balance V2 also has pending assessment cue pairs listed in `HALE_EYES_OPEN_BALANCE_V2_VOICE_ASSET_REQUIREMENTS.csv`.
