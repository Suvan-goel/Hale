You are carrying out Stage 3D of Pearl’s production-readiness work:
...
Stage 4 and Stage 5 remain blocked until Stage 3D determines whether Pearl’s score interpretations and claims are trustworthy enough to feed exercise-catalogue and workout-generation audits.

## Primary objective

Produce an evidence-based report answering:

1. Are the current norm tables sufficiently sourced and appropriate for Pearl’s target users aged roughly 45–65?
...
6. What changes are needed before Pearl can safely use its current scoring outputs to drive official Progress, block reports, and personalised training blocks?
...
- whether the source’s measurement protocol matches Pearl’s home-camera protocol;
...
- whether the norm table protocol matches Pearl’s 30-second chair-stand setup;
...
- whether the norm protocol matches Pearl’s front-camera home test;
...
Explicitly evaluate whether Pearl should use:
...
Recommended Pearl-safe framing should preserve the product’s value without making medical claims.
