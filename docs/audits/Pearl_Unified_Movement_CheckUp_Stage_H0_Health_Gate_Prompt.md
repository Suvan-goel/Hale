You are implementing the first execution stage of Pearl’s approved unified Movement Check-Up architecture:

PEARL UNIFIED MOVEMENT CHECK-UP — STAGE H0
...
- `docs/audits/PEARL_POSE_PIPELINE_LATENCY_REMEDIATION.md`, if present
