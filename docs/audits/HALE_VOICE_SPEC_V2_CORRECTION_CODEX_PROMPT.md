# Codex Prompt: Hale Voice Experience Specification V2 Correction, Decision Review, and Script Freeze Preparation
...
1. `docs/specs/HALE_VOICE_EXPERIENCE_SPEC_V2.md`
2. `docs/specs/HALE_VOICE_EXPERIENCE_SPEC_V2.json`
3. `docs/specs/HALE_VOICE_SCRIPT_REVIEW_V2.md`
4. `docs/specs/HALE_VOICE_SCRIPT_MANIFEST_V2.csv`
5. `docs/specs/HALE_VOICE_FOUNDER_DECISIONS.md`
6. `docs/specs/HALE_VOICE_COMPOSED_TIMELINES_V2.csv`

Do not overwrite or edit the V1 files.

## Deliverable purposes

### `HALE_VOICE_EXPERIENCE_SPEC_V2.md`

The corrected product and engineering specification.

### `HALE_VOICE_EXPERIENCE_SPEC_V2.json`
...
### `HALE_VOICE_SCRIPT_REVIEW_V2.md`
...
### `HALE_VOICE_SCRIPT_MANIFEST_V2.csv`
...
### `HALE_VOICE_FOUNDER_DECISIONS.md`
...
### `HALE_VOICE_COMPOSED_TIMELINES_V2.csv`
...
Avoid defensive language. State that Hale will guide the session without overpromising perfect eyes-off use.
...
# Hale Voice Experience Specification V2
