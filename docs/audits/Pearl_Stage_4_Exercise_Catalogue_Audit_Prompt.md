You are carrying out Stage 4 of Pearl’s production-readiness work:
...
Audit whether Pearl’s current exercise catalogue and progression ladders are safe, coherent, sufficiently challenging, and correctly mapped to the app’s strength/power, balance, and mobility training domains for adults roughly aged 45–65.
...
2. Are progressions/regressions safe and sensible for Pearl’s target users?
...
- any tests under src/training, src/pearlFlow, src/adherence, src/screens related to training, sessions, exercise catalogue, equipment, pain, readiness, progression, or blocks.
...
12. Does progression align with Pearl’s measurement domains?
...
- stale exercises from Forma/Pearl legacy;
