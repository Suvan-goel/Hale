You are implementing Stage 4E-R of Hale’s production-readiness work:
...
Final minimal-equipment positioning and Hale Movement Kit copy.
...
- “Hale will use the closest supported level.”
...
- “Hale will keep this level steady for now.”
...
```bash
rm -rf /tmp/hale-stage4er-export
npx --no-install expo export --platform all --output-dir /tmp/hale-stage4er-export
rc=$?
rm -rf /tmp/hale-stage4er-export
exit $rc
```
