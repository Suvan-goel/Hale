You are implementing Stage 3D-D of Pearl’s production-readiness work:
...
Implement a beta-safe interim policy so Pearl avoids overreacting to tiny score differences before device-repeatability validation.
...
- For small differences, use:
  ...
  - “Pearl will look for repeatable change over time.”
...
- “These areas are close enough that Pearl is using a practical starting focus.”
- “These areas are closely matched, so Pearl is keeping your current focus.”
- “Suggested focus”
- “Another data point”
