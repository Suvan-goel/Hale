# Codex Prompt: Pearl Step-Up Alternation End-to-End Runtime Integration Patch

Read this entire prompt before changing anything.

Pearl’s step-up alternation **model** is correct, but the verification addendum proved that it is not connected end to end to the actual training runtime.
...
- `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_IMPLEMENTATION.md`
- `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_AUDIT.md`
- `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_AUDIT.json`
- `docs/audits/PEARL_TRAINING_STEP_UP_ALTERNATION_SCENARIOS.csv`
- `docs/audits/PEARL_TRAINING_STEP_UP_REP_EVIDENCE_MATRIX.csv`
...
1. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_INTEGRATION_IMPLEMENTATION.md`
2. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_INTEGRATION_AUDIT.md`
3. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_INTEGRATION_AUDIT.json`
4. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_INTEGRATION_SCENARIOS.csv`
5. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_EVENT_EVIDENCE.csv`
6. `docs/audits/PEARL_TRAINING_STEP_UP_RUNTIME_INTEGRATION_TRACE_V2.csv`
7. `docs/audits/PEARL_VOICE_PROJECT_POST_STEP_UP_RUNTIME_HANDOFF.md`
...
# Pearl Training Step-Up Runtime Integration Implementation
