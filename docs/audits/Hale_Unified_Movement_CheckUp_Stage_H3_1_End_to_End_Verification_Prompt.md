You are carrying out the next verification stage of Hale’s approved unified Movement Check-Up architecture:

HALE UNIFIED MOVEMENT CHECK-UP — STAGE H3.1
...
```bash
rm -rf /tmp/hale-unified-h31-baseline-export
