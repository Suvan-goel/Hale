# Codex Prompt: Pearl MPV2 Voice Completion Patch — Tracking, Recovery, Retry, and Mounted Voice Switching

Read this entire prompt before changing anything.

Pearl’s MPV2 voice-runtime foundation is now implemented and has passed the post-foundation static/runtime gates.
...
Physical-device QA is intentionally deferred until the entire Pearl voice-cue project is implemented.
...
- `docs/audits/PEARL_MPV2_RUNTIME_FOUNDATION_IMPLEMENTATION.md`
- `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_FOUNDATION_AUDIT.md`
- `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_FOUNDATION_AUDIT.json`
- `docs/audits/PEARL_MPV2_POST_FOUNDATION_TIMELINES.csv`
- `docs/audits/PEARL_MPV2_POST_FOUNDATION_FINDINGS.csv`
- `scripts/audits/audit-mpv2-runtime-foundation.mjs`

## Previous targeted audit and remediation plan

- `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_AUDIT.md`
- `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_AUDIT.json`
- `docs/audits/PEARL_MPV2_RUNTIME_REMEDIATION_PLAN.md`
...
1. `docs/audits/PEARL_MPV2_VOICE_COMPLETION_IMPLEMENTATION.md`
2. `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_COMPLETION_AUDIT.md`
3. `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_COMPLETION_AUDIT.json`
4. `docs/audits/PEARL_MPV2_POST_COMPLETION_TIMELINES.csv`
5. `docs/audits/PEARL_MPV2_POST_COMPLETION_FINDINGS.csv`
6. `docs/audits/PEARL_VOICE_PROJECT_POST_MPV2_HANDOFF.md`
...
# Pearl MPV2 Voice Completion Implementation
...
Do not claim physical audible-onset accuracy or full Pearl voice-project completion in this task.
