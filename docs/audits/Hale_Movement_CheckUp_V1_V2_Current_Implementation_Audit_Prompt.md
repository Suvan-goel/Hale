You are carrying out a new read-only comparative product, scientific, UX, and software-architecture audit of Hale:

CURRENT MOVEMENT CHECK-UP AND RESULTS AUDIT — V1 VS MOVEMENT PROFILE V2 VS A UNIFIED HYBRID

The purpose of this audit is to determine what Hale should actually ship as its canonical Movement Check-Up and result experience.
...
Do not claim Hale is production-ready or physically validated.
...
```bash
rm -rf /tmp/hale-checkup-v1-v2-audit-export
...
- What was measured?
- Why did Hale give this result?
- Why did Hale choose this focus?
