# Pearl Warden Source Acquisition And Full Integration Continuation
...
Relied on the product-owner decision that Pearl has written permission from the Warden study authors to use the approved 30-second chair-stand percentile data/calculator/formula. The redacted permission summary remains:
...
```text
?? docs/audits/PEARL_WARDEN_CHAIR_PERCENTILE_FULL_INTEGRATION.md
?? docs/audits/Pearl_Warden_Source_Acquisition_and_Full_Integration_Continuation_Prompt.md
?? docs/sources/PEARL_WARDEN_PERMISSION_SUMMARY.md
```
...
Official web retrieval used the DOI and Oxford Academic article page. Only official DOI/OUP/Oxford Academic publisher links were used. Raw files were saved outside committed source under `/tmp/pearl-warden-source/raw/`.
...
```text
/tmp/pearl-warden-source/raw/supporting_material_1_test_procedure_pzab299.pdf
/tmp/pearl-warden-source/raw/supporting_material_2_calculator_v1_final_1_pzab299.xlsx
```
...
/tmp/pearl-warden-source/warden-30s-sts-lms-table.csv
...
```text
supporting_material_1_test_procedure_pzab299.pdf	727152 bytes	sha256=10424d9e1db9fdbde17029d8b664f3f43b6940c1ebc6850486cf04d3b04e9e50	/tmp/pearl-warden-source/raw/supporting_material_1_test_procedure_pzab299.pdf
supporting_material_2_calculator_v1_final_1_pzab299.xlsx	1175158 bytes	sha256=d16f1cf53a857ef6759e7fea2eb20f410de25f5febe734e9af3d25ade46484b8	/tmp/pearl-warden-source/raw/supporting_material_2_calculator_v1_final_1_pzab299.xlsx
warden-30s-sts-lms-table.csv	108029 bytes	sha256=bebec0be0e55de18c882328a4979bef010c60b48c9a3ace8f5c415dccc514952	/tmp/pearl-warden-source/warden-30s-sts-lms-table.csv
warden-chair-golden-examples.csv	3120 bytes	sha256=414fa338a712fe0b97688c776dd0523bb14efc2614cd40a295e5577aace0f42a	/tmp/pearl-warden-source/warden-chair-golden-examples.csv
```
...
- output is an exact internal percentile, which Pearl bins for public UI.
...
approvalId: pearl-warden-official-calculator-2026-06-27
enabled: true
```
...
- range high <= 25: Pearl starting point Strength / Power focus candidate;
- range high <= 40: Pearl building;
...
Physical-device validation was not performed and is not claimed. Public release remains blocked. Raw official source files remain local-only in `/tmp/pearl-warden-source/` and should be reacquired or manually supplied if the temp directory is cleared.
