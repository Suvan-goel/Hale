# Pearl Logic Remediation Stage 4F-R.1
...
```bash
rm -rf /tmp/pearl-stage4fr1-export
npx --no-install expo export --platform all --output-dir /tmp/pearl-stage4fr1-export
rc=$?
rm -rf /tmp/pearl-stage4fr1-export
exit $rc
```
