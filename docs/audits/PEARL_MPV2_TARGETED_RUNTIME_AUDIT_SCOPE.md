# Pearl MPV2 Targeted Runtime Audit Scope

This scope is for the later targeted runtime audit only. Do not treat it as completed by the listening review.

## Inputs

- Canonical runtime input: `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_AUDIT_INPUT.json`
- Canonical cue map: `docs/audits/PEARL_MPV2_VOICE_CANONICAL_MAP.csv`
