# Codex Prompt: Hale MPV2 / Voice V2.1 Asset–Source Reconciliation and Listening Review Pack

Read this entire prompt before starting.

Hale now has two overlapping voice efforts:
...
- `docs/audits/HALE_VOICE_V2_1_IMPACT_REPORT.md`
...
1. `docs/audits/HALE_MPV2_V21_VOICE_RECONCILIATION.md`
2. `docs/audits/HALE_MPV2_V21_VOICE_RECONCILIATION.json`
3. `docs/audits/HALE_MPV2_VOICE_CANONICAL_MAP.csv`
4. `docs/audits/HALE_MPV2_VOICE_ASSET_QC.csv`
5. `docs/audits/HALE_MPV2_VOICE_LISTENING_REVIEW.html`
6. `docs/audits/HALE_MPV2_VOICE_LISTENING_REVIEW_GUIDE.md`
7. `docs/audits/HALE_MPV2_TARGETED_RUNTIME_AUDIT_INPUT.json`
8. `docs/audits/HALE_MPV2_TARGETED_RUNTIME_AUDIT_SCOPE.md`
