You are carrying out the policy-aligned closure verification for Hale’s unified Movement Check-Up lifecycle:

HALE UNIFIED MOVEMENT CHECK-UP — STAGE H4.1.1
...
```bash
rm -rf /tmp/hale-unified-h411-export
npx --no-install expo export --platform all --output-dir /tmp/hale-unified-h411-export
rc=$?
rm -rf /tmp/hale-unified-h411-export
exit $rc
```
