# Codex Prompt: Pearl MPV2 Voice-Runtime Foundation Patch

Read this entire prompt before changing anything.

Pearl’s founder-waived targeted runtime audit is complete. It found four P1 blockers in the current Movement Profile V2 (`MPV2`) check-up voice path:
...
- `docs/audits/PEARL_MPV2_RUNTIME_TIMELINES.csv`
- `docs/audits/PEARL_MPV2_RUNTIME_FINDINGS.csv`
- `docs/audits/PEARL_MPV2_RUNTIME_REMEDIATION_PLAN.md`
- `docs/audits/PEARL_MPV2_LISTENING_REVIEW_WAIVER.md`
...
An awaitable required cue cannot leave Pearl stuck forever if a completion callback never arrives.
...
1. `docs/audits/PEARL_MPV2_RUNTIME_FOUNDATION_IMPLEMENTATION.md`
2. `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_FOUNDATION_AUDIT.md`
3. `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_FOUNDATION_AUDIT.json`
4. `docs/audits/PEARL_MPV2_POST_FOUNDATION_TIMELINES.csv`
5. `docs/audits/PEARL_MPV2_POST_FOUNDATION_FINDINGS.csv`
...
# Pearl MPV2 Voice-Runtime Foundation Implementation
