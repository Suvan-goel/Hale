# Codex Prompt: Hale Training Voice V2.1 Foundation and Exact 37-Level Mapping

Read this entire prompt before changing anything.

Hale’s check-up voice/runtime and measurement foundations are now substantially complete at the static/software level.
...
- `docs/audits/HALE_VOICE_PROJECT_POST_BALANCE_V2_HANDOFF.md`, if present
...
1. `docs/audits/HALE_TRAINING_VOICE_V2_1_FOUNDATION_IMPLEMENTATION.md`
2. `docs/audits/HALE_TRAINING_VOICE_V2_1_FOUNDATION_AUDIT.md`
3. `docs/audits/HALE_TRAINING_VOICE_V2_1_FOUNDATION_AUDIT.json`
4. `docs/audits/HALE_TRAINING_VOICE_V2_1_EXERCISE_CONTRACTS.csv`
5. `docs/audits/HALE_TRAINING_VOICE_V2_1_ASSET_REQUIREMENTS.csv`
6. `docs/audits/HALE_TRAINING_VOICE_V2_1_RUNTIME_READINESS.csv`
7. `docs/audits/HALE_VOICE_PROJECT_POST_TRAINING_FOUNDATION_HANDOFF.md`
