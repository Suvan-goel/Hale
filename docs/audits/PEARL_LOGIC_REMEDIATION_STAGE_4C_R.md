# Pearl Logic Remediation Stage 4C-R
...
```bash
npm test -- --runInBand src/profile/__tests__/movementCapabilities.test.ts src/profile/__tests__/serialize.test.ts src/training/__tests__/workoutGeneration.test.ts src/pearlFlow/__tests__/sessionPlanning.test.ts src/pearlFlow/__tests__/exploreViewModel.test.ts src/services/backend/__tests__/profileSyncService.test.ts
```
...
```text
 ...
 src/pearlFlow/__tests__/exploreViewModel.test.ts    |  46 ++-
 src/pearlFlow/__tests__/progressionEvidence.test.ts |  15 +
 src/pearlFlow/__tests__/sessionPlanning.test.ts     | 135 +++++++-
 .../__tests__/stage5g1ScheduleVerification.test.ts |  14 +
 .../__tests__/stage5hLifecycle.integration.test.ts |  24 +-
 src/pearlFlow/exploreViewModel.ts                   |  77 +++--
 src/pearlFlow/sessionPlanning.ts                    | 286 ++++++++++++++++-
