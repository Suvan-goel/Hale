# Codex Prompt: Hale Training Step-Up Alternating-Leading-Leg Implementation

Read this entire prompt before changing anything.

Hale’s Training both-sides round and dose-preservation phase is complete.
...
- `docs/audits/HALE_TRAINING_BOTH_SIDES_ROUNDS_AUDIT.json`
- `docs/audits/HALE_TRAINING_BOTH_SIDES_DOSE_CONVERSION_MATRIX.csv`
- `docs/audits/HALE_TRAINING_BOTH_SIDES_ROUND_SCENARIOS.csv`
...
1. `docs/audits/HALE_TRAINING_STEP_UP_ALTERNATION_IMPLEMENTATION.md`
2. `docs/audits/HALE_TRAINING_STEP_UP_ALTERNATION_AUDIT.md`
3. `docs/audits/HALE_TRAINING_STEP_UP_ALTERNATION_AUDIT.json`
4. `docs/audits/HALE_TRAINING_STEP_UP_ALTERNATION_SCENARIOS.csv`
5. `docs/audits/HALE_TRAINING_STEP_UP_REP_EVIDENCE_MATRIX.csv`
6. `docs/audits/HALE_VOICE_PROJECT_POST_STEP_UP_HANDOFF.md`
