You are implementing Stage 3A of Hale’s production-readiness work:
...
The following are now approved Hale product rules:
...
Inspect Hale’s existing observability wrapper.
