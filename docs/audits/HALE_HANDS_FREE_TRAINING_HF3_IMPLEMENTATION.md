# Hale Hands-Free Training HF3 Implementation
...
- `npx --no-install expo export --platform all --output-dir /tmp/hale-hf3-export` - passed for web, Android, and iOS; temp export directory removed afterward.
