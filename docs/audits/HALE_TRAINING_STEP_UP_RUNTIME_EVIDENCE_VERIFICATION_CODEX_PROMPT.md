# Codex Prompt: Hale Step-Up Runtime Integration Evidence Verification Addendum

Read this entire prompt before doing any work.

Hale’s step-up alternation runtime integration has been implemented behind default-closed internal gates.
...
1. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_VERIFICATION.md`
2. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_EVIDENCE_VERIFICATION.json`
3. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_VERIFICATION_SCENARIOS.csv`
4. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_VERIFICATION_EVENTS.csv`
5. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_VERIFICATION_LIFECYCLES.csv`
6. `docs/audits/HALE_TRAINING_STEP_UP_RUNTIME_VERIFICATION_FINDINGS.csv`
7. `docs/audits/HALE_VOICE_PROJECT_POST_STEP_UP_EVIDENCE_HANDOFF.md`
