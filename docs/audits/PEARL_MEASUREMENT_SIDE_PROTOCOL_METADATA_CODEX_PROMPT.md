# Codex Prompt: Pearl Measurement-Side Persistence and Protocol Metadata

Read this entire prompt before changing anything.

Pearl’s Movement Profile V2 (`MPV2`) voice runtime is now complete at the static/runtime level.
...
- `docs/audits/PEARL_MPV2_VOICE_COMPLETION_IMPLEMENTATION.md`, if present
- `docs/audits/PEARL_MPV2_TARGETED_RUNTIME_POST_COMPLETION_AUDIT.json`, if present
- `docs/audits/PEARL_MPV2_POST_COMPLETION_TIMELINES.csv`, if present
- `docs/audits/PEARL_MPV2_POST_COMPLETION_FINDINGS.csv`, if present
...
1. `docs/audits/PEARL_MEASUREMENT_SIDE_PROTOCOL_METADATA_IMPLEMENTATION.md`
2. `docs/audits/PEARL_MEASUREMENT_SIDE_PROTOCOL_METADATA_AUDIT.md`
3. `docs/audits/PEARL_MEASUREMENT_SIDE_PROTOCOL_METADATA_AUDIT.json`
4. `docs/audits/PEARL_MEASUREMENT_PROTOCOL_COMPATIBILITY_MATRIX.csv`
5. `docs/audits/PEARL_VOICE_PROJECT_POST_SIDE_PERSISTENCE_HANDOFF.md`
