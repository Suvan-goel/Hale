# Codex Prompt: Hale Consolidated Clara/Marcus Voice V2.1 Asset Generation

Read this entire prompt before doing anything.

Hale’s final Voice V2.1 cue schema reconciliation is complete.
...
```bash
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/hale_voice_v21_generation_audio_entry.sha256
find assets/audio -type f | sort > /tmp/hale_voice_v21_generation_audio_entry.files
```
...
1. The final generation plan is derived only from `HALE_VOICE_V2_1_GENERATION_BACKLOG.csv`.
...
```bash
npm run generate:audio -- --from-backlog docs/audits/HALE_VOICE_V2_1_GENERATION_BACKLOG.csv --voices clara,marcus --mode v2.1 --targeted
```
...
```text
/tmp/hale_voice_v21_generation_staging/<timestamp>/
```
...
1. `docs/audits/HALE_VOICE_V2_1_ASSET_GENERATION_IMPLEMENTATION.md`
2. `docs/audits/HALE_VOICE_V2_1_ASSET_GENERATION_AUDIT.md`
3. `docs/audits/HALE_VOICE_V2_1_ASSET_GENERATION_AUDIT.json`
4. `docs/audits/HALE_VOICE_V2_1_GENERATION_PLAN.csv`
5. `docs/audits/HALE_VOICE_V2_1_GENERATION_RESULT_LEDGER.csv`
6. `docs/audits/HALE_VOICE_V2_1_GENERATED_ASSET_INVENTORY.csv`
7. `docs/audits/HALE_VOICE_V2_1_POST_GENERATION_MANIFEST_CHANGES.csv`
8. `docs/audits/HALE_VOICE_V2_1_POST_GENERATION_TIMELINES.csv`
9. `docs/audits/HALE_VOICE_V2_1_POST_GENERATION_READINESS.csv`
10. `docs/audits/HALE_VOICE_V2_1_LISTENING_REVIEW_QUEUE.csv`
11. `docs/audits/HALE_VOICE_V2_1_LISTENING_REVIEW_GUIDE.md`
12. `docs/audits/HALE_VOICE_V2_1_LISTENING_REVIEW.html`
13. `docs/audits/HALE_VOICE_PROJECT_POST_ASSET_GENERATION_HANDOFF.md`
...
# Hale Voice V2.1 Asset Generation Implementation
...
```bash
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/hale_voice_v21_generation_audio_exit.sha256
find assets/audio -type f | sort > /tmp/hale_voice_v21_generation_audio_exit.files
```
