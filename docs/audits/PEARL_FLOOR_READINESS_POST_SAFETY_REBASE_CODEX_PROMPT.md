# Codex Prompt: Pearl Floor-Readiness Audit Post-Safety Rebase
...
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/pearl_floor_post_safety_audio_entry.sha256
```

At task completion record:

```bash
find assets/audio -type f | sort | xargs shasum -a 256 > /tmp/pearl_floor_post_safety_audio_exit.sha256
diff -u /tmp/pearl_floor_post_safety_audio_entry.sha256 /tmp/pearl_floor_post_safety_audio_exit.sha256
```
...
1. `docs/audits/PEARL_TRAINING_FLOOR_READINESS_POST_SAFETY_REBASE.md`
2. `docs/audits/PEARL_TRAINING_FLOOR_READINESS_POST_SAFETY_REBASE.json`
3. `docs/audits/PEARL_TRAINING_FLOOR_READINESS_POST_SAFETY_SCENARIOS.csv`
4. `docs/audits/PEARL_TRAINING_FLOOR_CONTRACT_MATRIX_POST_SAFETY.csv`
5. `docs/audits/PEARL_VOICE_PROJECT_POST_FLOOR_READINESS_POST_SAFETY_HANDOFF.md`
...
# Pearl Training Floor-Readiness Post-Safety Rebase
