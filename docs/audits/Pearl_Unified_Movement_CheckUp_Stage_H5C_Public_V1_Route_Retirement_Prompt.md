You are implementing the third substage of Pearl’s final unified Movement Check-Up migration:
...
```bash
rm -rf /tmp/pearl-unified-h5c-baseline-export
npx --no-install expo export --platform all --output-dir /tmp/pearl-unified-h5c-baseline-export
rc=$?
rm -rf /tmp/pearl-unified-h5c-baseline-export
exit $rc
```
