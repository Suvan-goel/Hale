You are implementing Stage 3D-B.2E-A.1 of Hale’s production-readiness work:
...
- valid best duration;
- choose a duration that produces a deterministic Hale band.
...
- use `HALE_VOICE_FOUNDER_DECISIONS.md` as the highest product-decision authority;
- record the conflict;
...
- `Your saved Check-Up needs a fresh internal run before Hale can show this profile.`
