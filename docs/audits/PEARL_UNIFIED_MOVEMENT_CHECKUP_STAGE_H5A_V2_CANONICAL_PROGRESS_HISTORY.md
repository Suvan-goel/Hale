# PEARL UNIFIED MOVEMENT CHECK-UP - STAGE H5A
...
```bash
npm test -- --runInBand src/pearlFlow/__tests__/movementProfileV2OfficialRetestH411Continuation.integration.test.ts src/pearlFlow/__tests__/movementProfileV2OfficialRetestContinuation.integration.test.ts src/pearlFlow/__tests__/movementProfileV2OfficialRetestTransition.test.ts src/checkup/__tests__/publicUnifiedMovementCheckUpLifecycle.integration.test.ts src/reference/movementProfileV2/__tests__/snapshot.test.ts src/reference/movementProfileV2/__tests__/assessment.test.ts src/reference/movementProfileV2/__tests__/persistence.test.ts src/results/__tests__/movementProfileV2ResultsAdapter.test.ts src/pearlFlow/__tests__/progressViewModel.test.ts src/screens/__tests__/CheckUpRecordingShell.test.ts src/pearlFlow/__tests__/appLifecycle.test.ts src/pearlFlow/__tests__/movementProfileV2Block.test.ts src/pearlFlow/__tests__/stage5g1ScheduleVerification.test.ts src/pearlFlow/__tests__/stage5hLifecycle.integration.test.ts src/services/backend/__tests__/restoreService.test.ts src/services/backend/__tests__/trainingStateSyncService.test.ts src/services/backend/__tests__/blockReportSyncService.test.ts src/training/__tests__/microCheck.test.ts src/services/backend/__tests__/microCheckSyncService.test.ts src/checkup/__tests__/publicCheckUpEngine.test.ts src/checkup/__tests__/checkupFlow.integration.test.ts
```
...
```bash
npm test -- --runInBand src/pearlFlow/__tests__/progressDataAuthority.test.ts src/pearlFlow/__tests__/movementProfileV2ProgressViewModel.test.ts src/pearlFlow/__tests__/progressViewModel.test.ts src/results/__tests__/movementProfileV2ResultsAdapter.test.ts
```
...
```bash
npm test -- --runInBand src/pearlFlow/__tests__/progressDataAuthority.test.ts src/pearlFlow/__tests__/movementProfileV2ProgressViewModel.test.ts src/pearlFlow/__tests__/movementProfileV2OfficialRetestH411Continuation.integration.test.ts src/pearlFlow/__tests__/movementProfileV2OfficialRetestContinuation.integration.test.ts src/pearlFlow/__tests__/movementProfileV2OfficialRetestTransition.test.ts src/checkup/__tests__/publicUnifiedMovementCheckUpLifecycle.integration.test.ts src/reference/movementProfileV2/__tests__/snapshot.test.ts src/reference/movementProfileV2/__tests__/assessment.test.ts src/reference/movementProfileV2/__tests__/persistence.test.ts src/results/__tests__/movementProfileV2ResultsAdapter.test.ts src/pearlFlow/__tests__/progressViewModel.test.ts src/screens/__tests__/CheckUpRecordingShell.test.ts src/pearlFlow/__tests__/appLifecycle.test.ts src/pearlFlow/__tests__/movementProfileV2Block.test.ts src/pearlFlow/__tests__/stage5g1ScheduleVerification.test.ts src/pearlFlow/__tests__/stage5hLifecycle.integration.test.ts src/services/backend/__tests__/restoreService.test.ts src/services/backend/__tests__/trainingStateSyncService.test.ts src/services/backend/__tests__/blockReportSyncService.test.ts src/training/__tests__/microCheck.test.ts src/services/backend/__tests__/microCheckSyncService.test.ts src/checkup/__tests__/publicCheckUpEngine.test.ts src/checkup/__tests__/checkupFlow.integration.test.ts
```
...
```bash
rm -rf /tmp/pearl-unified-h5a-export
npx --no-install expo export --platform all --output-dir /tmp/pearl-unified-h5a-export
rc=$?
rm -rf /tmp/pearl-unified-h5a-export
exit $rc
```
...
```text
docs/audits/PEARL_TRAINING_FLOOR_CONTRACT_MATRIX.csv
docs/audits/PEARL_TRAINING_FLOOR_READINESS_AUDIT.json
docs/audits/PEARL_TRAINING_FLOOR_READINESS_AUDIT.md
docs/audits/PEARL_TRAINING_FLOOR_READINESS_IMPLEMENTATION.md
docs/audits/PEARL_TRAINING_FLOOR_READINESS_SCENARIOS.csv
docs/audits/PEARL_TRAINING_FLOOR_TRANSFER_READINESS_CODEX_PROMPT.md
...
docs/audits/Pearl_Unified_Movement_CheckUp_Stage_H5A_V2_Canonical_Progress_History_Prompt.md
