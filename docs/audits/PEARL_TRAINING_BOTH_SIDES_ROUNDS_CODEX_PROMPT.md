# Codex Prompt: Pearl Training Both-Sides Round State and Dose Preservation

Read this entire prompt before changing anything.

Pearl’s Training Voice V2.1 software foundation is complete and safely default-closed.
...
1. `docs/audits/PEARL_TRAINING_BOTH_SIDES_ROUNDS_IMPLEMENTATION.md`
2. `docs/audits/PEARL_TRAINING_BOTH_SIDES_ROUNDS_AUDIT.md`
3. `docs/audits/PEARL_TRAINING_BOTH_SIDES_ROUNDS_AUDIT.json`
4. `docs/audits/PEARL_TRAINING_BOTH_SIDES_DOSE_CONVERSION_MATRIX.csv`
5. `docs/audits/PEARL_TRAINING_BOTH_SIDES_ROUND_SCENARIOS.csv`
6. `docs/audits/PEARL_VOICE_PROJECT_POST_BOTH_SIDES_ROUNDS_HANDOFF.md`
...
# Pearl Training Both-Sides Rounds Implementation
