# Codex Prompt: Hale Measurement-Side UX Completion Patch

Read this entire prompt before changing anything.

Hale’s measurement-side and protocol-metadata foundation is implemented, but its latest audit returned:
...
- Physical Android/iOS QA remains deferred until the whole Hale voice project is complete.
...
2. When a compatible side anchor exists, Hale recommends and preselects it.
...
- Accessibility and large-target UI suitable for Hale’s 45–65 audience.
- Focused tests.
...
Use Hale’s existing premium component system.
...
1. `docs/audits/HALE_MEASUREMENT_SIDE_UX_COMPLETION_IMPLEMENTATION.md`
2. `docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_POST_UX_AUDIT.md`
3. `docs/audits/HALE_MEASUREMENT_SIDE_PROTOCOL_POST_UX_AUDIT.json`
4. `docs/audits/HALE_MEASUREMENT_SIDE_UX_SCENARIOS.csv`
5. `docs/audits/HALE_VOICE_PROJECT_POST_SIDE_UX_HANDOFF.md`
