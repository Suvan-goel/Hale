...
HALE UNIFIED MOVEMENT CHECK-UP — STAGE H4.1
...
```bash
rm -rf /tmp/hale-unified-h41-baseline-export
...
```bash
rm -rf /tmp/hale-unified-h41-export
npx --no-install expo export --platform all --output-dir /tmp/hale-unified-h41-export
rc=$?
rm -rf /tmp/hale-unified-h41-export
exit $rc
```
