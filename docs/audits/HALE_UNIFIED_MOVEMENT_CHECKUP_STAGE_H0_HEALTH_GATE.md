# Hale Unified Movement Check-Up Stage H0 Health Gate
...
```text
 ...
 src/haleFlow/__tests__/progressViewModel.test.ts   |    5 +-
 src/haleFlow/progressViewModel.ts                  |  118 ++-
 src/haleFlow/reports.ts                            |  109 +-
...
- `/tmp/hale-hybrid-h0-export` was removed after export.
