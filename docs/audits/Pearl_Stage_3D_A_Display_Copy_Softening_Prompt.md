You are implementing Stage 3D-A of Pearl’s production-readiness work:
...
Stage 3D found that Pearl’s scoring pipeline is now much safer after Stages 3A, 3B, 3C, and 3C.1, but the interpretation/copy layer still overstates certainty.
...
Make Pearl’s result, progress, report, onboarding, and summary copy beta-safe by:
...
- “Pearl’s suggested focus from this Check-Up”
...
- Any copy from `src/pearlFlow/copy.ts`.

Required changes:

- “validated movement tests” -> “guided movement checks” or “published movement tests,” depending on context.
- “area Pearl measured first” -> “area Pearl suggested first” or “focus from your Check-Up.”
