You are implementing Stage 3D-B.2E-A of Hale’s production-readiness work:
...
- `This result needs a fresh internal Check-Up before Hale can show the profile.`
...
- `Hold still while Hale finds your position.`
