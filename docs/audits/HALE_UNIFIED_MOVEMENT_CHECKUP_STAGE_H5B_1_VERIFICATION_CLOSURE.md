# Hale Unified Movement Check-Up - Stage H5B.1 Verification Closure
...
- `HALE_UNIFIED_MOVEMENT_CHECKUP_STAGE_H5B_BALANCED_MICRO_CHECK_POLICY.md`
- `HALE_UNIFIED_MOVEMENT_CHECKUP_STAGE_H5A_V2_CANONICAL_PROGRESS_HISTORY.md`
- `HALE_UNIFIED_MOVEMENT_CHECKUP_STAGE_H4_1_1_POLICY_ALIGNED_CLOSURE_CONTINUATION.md`
- `HALE_UNIFIED_MOVEMENT_CHECKUP_STAGE_H4_OFFICIAL_RETEST_REPORT_NEXT_BLOCK.md`
- `HALE_LOGIC_VERIFICATION_STAGE_5G_1.md`
- `HALE_LOGIC_VERIFICATION_STAGE_5H.md`
...
Initial tracked dirty files included `App.tsx`, `docs/decisions.md`, `src/haleFlow/microCheckPolicy.ts`, `src/haleFlow/microCheck.ts`, H5/H4/H5A tests, render work, backend sync/restore work, training runtime work, and voice V2.1 work. Initial untracked files included H4/H5 audit reports/prompts, `src/haleFlow/__tests__/microCheckPolicy.test.ts`, `src/haleFlow/microCheckPolicy.ts`, H5A Progress files, Step-Up/floor/voice audit files, render prototype files, and training runtime files. All were treated as user-owned.
...
- Baseline export to `/tmp/hale-unified-h5b1-baseline-export`: Android and iOS bundles passed, 444 assets, temp directory removed.
...
| --- | --- | --- | --- | --- |
| Policy version/fingerprint | `src/haleFlow/microCheckPolicy.ts` | Pure | `microCheckPolicy.test.ts` | `microCheckPolicyH5B1.test.ts` |
...
- `src/haleFlow/__tests__/microCheckPolicyH5B1.test.ts`
...
- `src/haleFlow/__tests__/microCheckPolicyH5B1.test.ts` with 10 tests.
...
```text
npm test -- --runInBand src/haleFlow/__tests__/microCheckPolicyH5B1.test.ts src/services/backend/__tests__/microCheckPersistenceH5B1.integration.test.ts src/training/__tests__/store.test.ts
...
```text
rm -rf /tmp/hale-unified-h5b1-export
npx --no-install expo export --platform all --output-dir /tmp/hale-unified-h5b1-export
rc=$?
rm -rf /tmp/hale-unified-h5b1-export
exit $rc
```
