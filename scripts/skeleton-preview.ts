...
const skeleton = {
  background: '#F7F5EF',
  figureTop: '#526B55', // soft gradient - lit sage at the top
  figureBottom: '#1E2D23', // settling to green-black ink at the base
  dim: '#B7B2A8', // muted, lower-contrast for occluded parts
};
