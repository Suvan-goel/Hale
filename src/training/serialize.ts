...
function validGeneratedSessionSummary(v: unknown): PersistedGeneratedSessionSummary | null {
  ...
  return {
    ...
    plannedPrimaryDomain: isTrainingDomain(s.plannedPrimaryDomain) ? s.plannedPrimaryDomain : undefined,
...
function validFocusStimulusEvidence(v: unknown): PersistedGeneratedSessionSummary['focusStimulusEvidence'] {
  ...
  const summary = {
    ...
    plannedPrimaryDomain: isTrainingDomain(e.plannedPrimaryDomain) ? e.plannedPrimaryDomain : undefined,
