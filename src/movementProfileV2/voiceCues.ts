...
export const MOVEMENT_PROFILE_V2_CUE_DEFINITIONS: readonly MovementProfileV2CueDefinition[] = [
  ...
  definition('mpv2_balance_attempt_start', "Lift your other foot when you're ready. This attempt can last up to 45 seconds.", 'active_transition', 60, 'stage_3d_b_2e_a_1_fallback'),
  ...
  definition('checkup-balance-single-leg-v21', 'Single-leg. Stand on your selected leg and lift the other foot slightly.', 'setup', 60, 'approved_v21'),
