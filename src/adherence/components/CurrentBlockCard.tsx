...
const styles = StyleSheet.create({
  ...
  copy: { flex: 1 },
  eyebrow: { ...type.label },
  title: { ...type.cardTitle, marginTop: spacing.xs },
  body: { ...type.cardBody },
  ...
  statValue: { ...type.cardRowTitle, textTransform: 'capitalize', fontVariant: ['tabular-nums'] },
  statLabel: { ...type.cardCaption, marginTop: 2 },
  protection: { ...type.cardRowTitle, color: colors.accentDeep },
