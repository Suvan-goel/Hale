...
>(function ConstellationPoseRenderer(
  ...
  const publishPaths = React.useCallback((next: ConstellationPaths) => {
    ...
    >
      <Svg style={StyleSheet.absoluteFill}>
        ...
        <Path
          ...
          fill="none"
        />
        <Path d={paths.softSampleDotPath || EMPTY_D} fill={colors.accentGold} fillOpacity={0.34 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.mediumSoftSampleDotPath || EMPTY_D} fill={colors.accentGold} fillOpacity={0.24 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.lowSoftSampleDotPath || EMPTY_D} fill={colors.accentGold} fillOpacity={0.14 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.sampleDotPath || EMPTY_D} fill={skeleton.figureTop} fillOpacity={0.5 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.mediumSampleDotPath || EMPTY_D} fill={skeleton.figureTop} fillOpacity={0.36 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.lowSampleDotPath || EMPTY_D} fill={skeleton.figureTop} fillOpacity={0.2 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.emphasizedSoftSampleDotPath || EMPTY_D} fill={colors.accentGold} fillOpacity={0.12 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.emphasizedSampleDotPath || EMPTY_D} fill={colors.accentGold} fillOpacity={0.16 * paths.avatarOpacity * paths.sampleDotOpacityMultiplier} />
        <Path d={paths.jointDotPath || EMPTY_D} fill={skeleton.bright} fillOpacity={(0.86 + paths.pulse) * paths.avatarOpacity * paths.keypointOpacityMultiplier} />
        <Path d={paths.mediumJointDotPath || EMPTY_D} fill={skeleton.bright} fillOpacity={0.6 * paths.avatarOpacity * paths.keypointOpacityMultiplier} />
        <Path d={paths.lowJointDotPath || EMPTY_D} fill={skeleton.bright} fillOpacity={0.32 * paths.avatarOpacity * paths.keypointOpacityMultiplier} />
        <Path d={paths.emphasizedJointDotPath || EMPTY_D} fill={colors.accentGold} fillOpacity={0.18 * paths.avatarOpacity * paths.keypointOpacityMultiplier} />
      </Svg>
    </View>
  );
});
